...
namespace ExportToExcel
{
    ...
    {
        public static bool CreateExcelDocument<T>(List<T> list, Stream stream, string SheetName)
        {
            DataSet ds = new DataSet();
            ds.Tables.Add(ListToDataTable(list));

            return CreateExcelDocument(ds, stream, SheetName);
        }
...
#region HELPER_FUNCTIONS
        ...
        public static bool CreateExcelDocument(DataTable dt, Stream stream,string SheetName)
        {
            DataSet ds = new DataSet();
            ds.Tables.Add(dt);
            bool result = CreateExcelDocument(ds, stream, SheetName);
            ds.Tables.Remove(dt);
            return result;
        }
#endregion
        ...
        public static bool CreateExcelDocument(DataSet ds, Stream stream, string SheetName)
        {
            try
            {
                using (SpreadsheetDocument document = SpreadsheetDocument.Create(stream, SpreadsheetDocumentType.Workbook))
                {
                    WriteExcelFile(ds, document, SheetName);
                }
                return true;
            }
            catch (Exception ex)
        ...
        private static void WriteExcelFile(DataSet ds, SpreadsheetDocument spreadsheet, string SheetName)
        {
